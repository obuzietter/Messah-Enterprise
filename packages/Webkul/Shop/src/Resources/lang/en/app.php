...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'bagisto'              => 'Messah Enterprise',
            'email'                => 'Email',
            'email-not-exist'      => 'We cannot find a user with that email address.',
            'footer'               => '© Copyright 2023 - :current_year, Messah Enterprise (Registered in Kenya). All rights reserved.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'email'                  => 'Email',
                'footer-text'            => '© Copyright 2023 - :current_year, Messah Enterprise (Registered in Kenya). All rights reserved.',
                'locale'                 => 'Locale',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'mini-cart' => [
                ...
                'offer-on-orders'      => 'Make your first Order Now!',
                'remove'               => 'Remove',
                'see-details'          => 'See Details',
